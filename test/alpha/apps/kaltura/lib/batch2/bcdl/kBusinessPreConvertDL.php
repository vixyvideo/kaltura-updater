...
class kBusinessPreConvertDL
{
	...
	public static function redecideFlavorConvert($flavorAssetId, $flavorParamsOutputId, $mediaInfoId, BatchJob $parentJob, $lastEngineType)
	{
		...
		return self::decideFlavorConvert($flavorAsset, $flavor, $originalFlavorAsset, $mediaInfoId, $parentJob, $lastEngineType);
	}
	...
	public static function decideAddEntryFlavor(BatchJob $parentJob = null, $entryId, $flavorParamsId, &$errDescription, $flavorAssetId = null, array $dynamicAttributes = array())
	{
		...
		{
			return self::decideFlavorConvert($flavorAsset, $flavor, $originalFlavorAsset, $mediaInfoId, $parentJob);
		}
...
//			return $ret; 
	...
	public static function decideProfileFlavorsConvert(BatchJob $parentJob, BatchJob $convertProfileJob, array $flavors, array $conversionProfileFlavorParams, $conversionProfileId, mediaInfo $mediaInfo = null)
	{
		...
		foreach($finalFlavors as $flavor)
		{
			...
			{	
				...
				$createdJob = self::decideFlavorConvert($flavorAsset, $flavor, $originalFlavorAsset, $madiaInfoId, $parentJob);
	...
	public static function decideFlavorConvert(flavorAsset $flavorAsset, flavorParamsOutput $flavor, flavorAsset $originalFlavorAsset, $mediaInfoId = null, BatchJob $parentJob = null, $lastEngineType = null)
	{
		...
		return kJobsManager::addFlavorConvertJob($srcSyncKeys, $flavor, $flavorAsset->getId(), $mediaInfoId, $parentJob, $lastEngineType);
	}
