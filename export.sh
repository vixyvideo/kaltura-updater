...
TAGS="falcon_2012_08_20"
TAGS="$TAGS gemini_2012_09_19"
...
do
	...
	then
	    ...
	    $(SSHPASS=onlyread SVN_SSH='/usr/bin/sshpass -e ssh' /usr/bin/svn export  --username 'svnread' --password 'onlyread' svn+ssh://svnread@kelev.kaltura.com/usr/local/kalsource/backend/server/tags/$TAG "exports/$TAG")
	else 
